...
If Order is not completed (items not yet packed for shipping) Customer may request cancellation of part or all of the order. See [Customer Cancels Order](Customer Cancels Order) for the process once Customer has initiated this.
