...
* Read the [Issue and Pull Request Guide](/docs/moqui/Issue+and+Pull+Request+Guide)
...
* Subscribe to mailing lists for commit notifications and development discussions
    * Moqui Framework
        * moqui@googlegroups.com
        * https://groups.google.com/d/forum/moqui
    * Mantle Business Artifacts
        * mantleba@googlegroups.com
        * https://groups.google.com/d/forum/mantleba
    * Moqui Applications
        * moqui-applications@googlegroups.com
        * https://groups.google.com/d/forum/moqui-applications
* Join the Moqui Ecosystem group on LinkedIn for wider audience discussions
    * http://www.linkedin.com/groups?gid=4640689
* Watch the 'moqui' tag on StackOverflow
    * https://stackoverflow.com/tags/moqui

## Becoming a Moderator

Under the moderation model used for all Moqui Ecosystem projects a moderator is an individual with write (push) access to one or more repositories. Many open source organizations use the term _committer_ for those with write access. The term moderator implies more than just being a committer. A _moderator_ is a member of the core group responsible for the overall health and quality of the code including considerations like backward compatibility and applicability to a wide variety of technical and business requirements going beyond the concerns of any particular project or product based on the open source code.
